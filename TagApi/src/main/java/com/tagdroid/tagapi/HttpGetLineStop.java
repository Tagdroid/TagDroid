...
public class HttpGetLineStop extends AsyncTask<Void, Integer, Void> {
    private final String RequestUrl;
    private String responseString;
    private ProgressionInterface progressionInterface;

    public HttpGetLineStop(Integer lineId, Integer direction, ProgressionInterface progressionInterface) {
        this.progressionInterface = progressionInterface;
        this.RequestUrl =
                "http://transinfoservice.ws.cityway.fr/TAG/api/transport/v2/GetLineStops/json"
