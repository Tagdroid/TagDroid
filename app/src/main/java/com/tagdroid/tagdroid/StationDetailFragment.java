...
public class StationDetailFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		...
		//Gestion des favoris	
		prefName = MainActivity.prefs2.getBoolean(titre+"&"+ligne1+"_cb",false);
        return view;
	}
	        ...
	        switch (item.getItemId()) {	 
	    		...
	    		case R.id.menu_favoris:    
	    				...
	    				for (String item3 : menuItems) {
	    					...
	    					if (res==1 && MainActivity.prefs2.getAll().size()!=0) mItem.counter= (MainActivity.prefs2.getAll().size()/6); 
